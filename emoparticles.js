...
var distributedZ = function(level) {
  var z;
  if (level === 1) {
    z = getRandomInt(2000, 5000);
  } else if (level === 2) {
    z = getRandomInt(10000, 30000);
  } else {
    z = getRandomInt(40000, 60000);
  }
...
//   var z;
//   if (level === 1) {
//     z = getRandomInt(500, 1000);
//   }
//   else if (level === 2) {
//     z = getRandomInt(3500, 4000);
//   } else {
//     z = getRandomInt(6500, 7000);
//   }
//
//   return z;
// };
